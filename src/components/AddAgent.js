            ...
            <div className="card-body">
                <form onSubmit={handleAdd}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="firstNameTextBox" onChange={handleFNChange} className="form-control" placeholder="I'm required" required/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="middleNameTextBox">Middle Name:</label>
                        <input type="text" id="middleNameTextBox" onChange={handleMNChange} className="form-control" placeholder="I'm required" required/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="firstLastTextBox">Last Name:</label>
                        <input type="text" id="lastNameTextBox" onChange={handleLNChange} className="form-control" placeholder="I'm required" required/>
                    </div>
                    <div className="form-group">
